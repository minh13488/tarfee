...
class Ynresponsive1_BootHelper extends Zend_Controller_Action_Helper_Abstract
{
	...
	*/
	public function postDispatch()
	{
        ...
        {
            $view -> headScript() -> appendFile($protocol.'ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js');
        }
        else 
        {
            $view -> headScript() -> appendFile($protocol.'ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js');
