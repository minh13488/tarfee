					...
					<div class="ynresume-features-item-footer">
	                	...
	                	<?php else :?>
							...
							<div class="ynresume-features-item-action">
								...
								<li><a id="ynresume_save_feature<?php echo $resume -> getIdentity();?>" onclick="saveResumeFeature('<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><i class="fa fa-floppy-o"></i><?php echo ($resume -> hasSaved())? $this -> translate('Saved Resume') : $this -> translate('Save Resume');?></a></li>
								<?php endif;?>
								<li><a href="<?php echo $resume->getOwner()->getHref();?>"><i class="fa fa-eye"></i><?php echo $this -> translate('View Profile');?></a></li>
								</ul>		
							</div>	
	...
	function saveResumeFeature(id)
	{
		new Request.JSON({
	        ...
	        onComplete: function(responseJSON, responseText) {
	            ...
	            {
	            	$("ynresume_save_feature"+id).set("html", '<i class="fa fa-floppy-o"></i><?php echo $this -> translate("Saved Resume");?>');
