	...
	<div class="ynresume-cover-content">	
		<div class="ynresume-cover-description">
			<?php if(!empty($resume)):?>  
				...
				<a class="button bold" id="ynresume_favourite_<?php echo $resume -> getIdentity();?>" onclick="favouriteResume('<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><?php echo ($resume -> hasFavourited()) ? $this -> translate('Favourited') : $this -> translate('Favourite');?></a>
		...
		function favouriteResume(id)
		{
			new Request.JSON({
		        ...
		        onComplete: function(responseJSON, responseText) {
		            if (responseJSON.save == '1')
		            {
		            	$("ynresume_favourite_"+id).set("html", '<?php echo $this -> translate("Favourited");?>');
		            }
		            else
		            {
		            	$("ynresume_favourite_"+id).set("html", '<?php echo $this -> translate("Favourite");?>');
		            }
