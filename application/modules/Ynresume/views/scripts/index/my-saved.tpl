                ...
                <div class="ynresume-user-item-footer">
                    ...
                    <div class="ynresume-user-item-action">
                        ...
                        <ul class="ynresume-show-options">
                            ...
                            <li><a id="ynresume_save_<?php echo $resume -> getIdentity();?>" onclick="saveResume(this, '<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><i class="fa fa-floppy-o"></i><?php echo $this -> translate('Saved Resume');?></a></li>
