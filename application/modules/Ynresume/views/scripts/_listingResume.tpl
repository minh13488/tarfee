	                ...
	                <?php else :?>
		                ...
		                <div class="ynresume-layout-list-item-action">
		                    ...
		                    <ul class="ynresume-show-options">
								...
								<li><a id="ynresume_save_listing<?php echo $resume -> getIdentity();?>" onclick="saveResume('<?php echo $resume -> getIdentity() ;?>');" href="javascript:;"><i class="fa fa-floppy-o"></i><?php echo ($resume -> hasSaved())? $this -> translate('Saved Resume') : $this -> translate('Save Resume');?></a></li>
								<?php endif;?>
								<li><a href="<?php echo $resume->getOwner()->getHref();?>"><i class="fa fa-eye"></i><?php echo $this -> translate('View Profile');?></a></li>
		                    </ul>       
		                </div>  
...
function saveResume(id)
{
	new Request.JSON({
        ...
        onComplete: function(responseJSON, responseText) {
            ...
            {
            	$("ynresume_save_listing"+id).set("html", '<i class="fa fa-floppy-o"></i><?php echo $this -> translate("Saved Resume");?>');
