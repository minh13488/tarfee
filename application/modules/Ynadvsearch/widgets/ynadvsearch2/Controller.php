...
class Ynadvsearch_Widget_Ynadvsearch2Controller extends Engine_Content_Widget_Abstract
{
	public function indexAction() {
		...
		$this->view->sport = Zend_Controller_Front::getInstance ()->getRequest ()->getParam('sport',array('all') + array_keys(Engine_Api::_()->getDbTable('sportcategories', 'user')->getCategoriesLevel1Assoc()));
