<div class='count_results'>
    ...
    <span class="label_results"><?php echo $this->htmlLink(array('route'=>'classified_general'), $this->label_content, array());?></span>
</div>
...
<?php elseif( $this->category || $this->show == 2 || $this->search ):?>
  <div class="tip">
    <span>
      <?php echo $this->translate('There were no classified listings found matching your search criteria.');?>
    </span>
  </div>
<?php else:?>
  <div class="tip">
