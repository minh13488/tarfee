	...
	protected function _addDashboardContactPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Edit Contact Form Page',
	...
	protected function _addDashboardAnnouncementPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Manage Announcement Page',
	...
	protected function _addDashboardTransferOwnerPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Transfer Owner Page',
	...
	protected function _addDashboardThemePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Theme Page',
	...
	protected function _addDashboardFeaturePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Feature Page',
	...
	protected function _addDashboardPackagePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Package Page',
                'title' => 'Business Pages Package Page',
	...
	protected function _addDashboardEditBusinessPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Edit Business Page',
	...
	protected function _addCreateStep2BusinessPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Create New Business Main Page',
	...
	protected function _addCreateStep1BusinessPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Choose Package Page',
	...
	protected function _addBrowseBusinessesPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Browse Businesses',
	...
	protected function _addBusinessesListingPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Businesses Listing Page',
	...
	protected function _addMyBusinessesPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages My Businesses Page',
	...
	protected function _addMyClaimBusinessesPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages My Claim Businesses Page',
	...
	protected function _addMyFollowBusinessesPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages My Following Businesses Page',
	...
	protected function _addMyFavouriteBusinessesPage() { 
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages My Favourite Businesses Page',
	...
	protected function _addCreateNewClaimBusinessPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Create New Claim Business Page',
    ...
    protected function _addCreateNewBusinessPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Create New Business Page',
    ...
    protected function _addFaqsPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages FAQs Page',
	...
	protected function _addBusinessDetailPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Detail Page',
    ...
    protected function _addComparePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Compare Page',
    ...
    protected function _addDashboardModulePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Modules',
	...
	protected function _addDashboardManageLayoutPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Manage Page',
	...
	protected function _addDashboardCoverPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Cover Photos',
	...
	protected function _addDashboardManageRolePage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Manage Roles',
	...
	protected function _addDashboardRoleSettingPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Role Setting',
	...
	protected function _addDashboardStatisticsPage() {
        ...
        if(!$page_id) {
            $db->insert('engine4_core_pages', array(
                ...
                'displayname' => 'Business Pages Dashboard Statistics',
