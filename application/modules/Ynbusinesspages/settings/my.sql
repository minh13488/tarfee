...
('ynbusinesspages_claim_success', 'ynbusinesspages', 'The claim request for business {item:$object} has just been claimed successfully.', 0, ''),
...
('ynbusinesspages_main', 'standard', 'YN Business Pages Main Navigation Menu', 999);

-- insert back-end menu items
INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `order`) VALUES
('core_admin_main_plugins_ynbusinesspages', 'ynbusinesspages', 'YN - Business Pages', '', '{"route":"admin_default","module":"ynbusinesspages","controller":"settings", "action":"global"}', 'core_admin_main_plugins', '', 999),
...
('core_main_ynbusinesspages', 'ynbusinesspages', 'Business Pages', '', '{"route":"ynbusinesspages_general"}', 'core_main', '', 1, 0, 999),
