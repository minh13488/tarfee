...
class Ynbusinesspages_Api_Core extends  Core_Api_Abstract {
	...
	function getPhotoSpan($item, $type = null)
  	{
  		...
  		if (!$photoUrl)
		{
			...
			$photoUrl = $view->baseUrl().'/application/modules/Ynbusinesspages/externals/images/nophoto_business_thumb_profile.png';
		}
    ...
    function getFeaturedSpan($item, $type = null)
    {
        ...
        {
        	$view = Zend_Registry::get("Zend_View");
            $photoUrl = $view->baseUrl().'/application/modules/Ynbusinesspages/externals/images/default_bussiness_featured.png';
        }
        else 
        {
