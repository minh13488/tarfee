    ...
    <div class="ynbusinesspages-package-item">
            ...
            <div class="package-price-group">
                ...
                <div class="package-price">
                    ...
                    ?>
                    <span class="price"><?php echo $currentPackage.$this->translate(array(' for %s day', ' for %s days', $currentPackage->valid_amount), $currentPackage->valid_amount);?></span>
                </div>      
            </div>      
        ...
        <div class="ynbusinesspages-package-item">
            ...
            <div class="package-price-group">
                ...
                <div class="package-price">
                    ...
                    ?>
                    <span class="price"><?php echo $price.$this->translate(array(' for %s day', ' for %s days', $package->valid_amount), $package->valid_amount);?></span>
                </div>
            </div>
            <div class="package-features-available">
                <span class="label"><?php echo $this->translate('Features Available:')?></span>
