		...
		<li>
			<div class="ynbusinesspages-company-item">
				...
				<div class="ynbusinesspages-company-item-content">
					...
					<div><span class="ynbusinesspages-grey"><?php echo $this -> translate('Status') ;?>:</span> <span class="ynbusinesspages-company-item-manage-status"><?php echo $business -> status ?></span></div>
					<div class="ynbusinesspages-company-item-package-exp"><span class="ynbusinesspages-grey"><?php echo $this -> translate('Package') ;?>:</span> <span><?php if($package -> getIdentity()) echo $package -> getTitle();?></span></div>
