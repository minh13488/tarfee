<div class="form-wrapper form-ynbusinesspages-choose-theme">
	...
	<div class="form-element">
		<div class="item-form-theme-choose">
			...
			<img src="<?php echo $this->baseUrl();?>/application/modules/Ynbusinesspages/externals/images/theme1.png" />
		</div>
		<div class="item-form-theme-choose">
			<input id='category_theme2' type='checkbox' name='themes[]' value ='theme2'>
			<img src="<?php echo $this->baseUrl();?>/application/modules/Ynbusinesspages/externals/images/theme2.png" />
		</div>
		<div class="item-form-theme-choose">
			<input id='category_theme3' type='checkbox' name='themes[]' value ='theme3'>
			<img src="<?php echo $this->baseUrl();?>/application/modules/Ynbusinesspages/externals/images/theme3.png" />
		</div>
	</div>
</div>
