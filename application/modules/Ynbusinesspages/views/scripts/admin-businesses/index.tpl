<script src="<?php $this->baseURL()?>application/modules/Ynbusinesspages/externals/scripts/picker/Locale.en-US.DatePicker.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynbusinesspages/externals/scripts/picker/Picker.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynbusinesspages/externals/scripts/picker/Picker.Attach.js" type="text/javascript"></script> 
<script src="<?php $this->baseURL()?>application/modules/Ynbusinesspages/externals/scripts/picker/Picker.Date.js" type="text/javascript"></script> 
<link href="<?php $this->baseURL()?>application/modules/Ynbusinesspages/externals/styles/picker/datepicker_dashboard.css" rel="stylesheet">
	  ...
	  <tbody>
	    <?php foreach ($this->paginator as $item): ?>
	      <tr>
        	...
        	<td>
	      	<input type="checkbox" class="never-expire_checkbox" onclick="neverExpireBusiness(this, '<?php echo $item->getIdentity()?>')" <?php if ($item->never_expire) echo 'checked'?>/>
	      	</td>
	      	<td>
      		<?php if($item -> status != 'deleted') :?>
	      		<!-- View -->
