<?php
	$this->headScript()
        ->appendFile($this->baseUrl() . '/application/modules/Ynbusinesspages/externals/scripts/jquery-1.7.1.min.js')
        ->appendFile($this->baseUrl() . '/application/modules/Ynbusinesspages/externals/scripts/jquery.flexslider.js');
	$this->headLink()
        ->appendStylesheet($this->baseUrl() . '/application/modules/Ynbusinesspages/externals/styles/flexslider.css');
?>
								...
								<div class="ynbusinesspages-featured-item-info">
									...
									<?php if ($category):?>
										<span class="ynbusinesspages-featured-item-categories">
											<i class="fa fa-folder-open-o"></i> <?php echo $category -> title; ?>	
										</span>
									<?php endif;?>
								</div>
								<?php endif;?>
