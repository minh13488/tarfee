...
class Ynbusinesspages_Plugin_Core
{
	...
	public function onItemDeleteAfter($event)
	{
		...
		if(in_array($payload['type'], array('video', 'music_playlist', 'mp3music_album', 'event', 'blog', 'classified', 'groupbuy_deal', 'contest', 'ynlistings_listing', 'poll', 'folder', 'ynwiki_page', 'ynbusinesspages_photo', 'ynbusinesspages_post', 'ynbusinesspages_topic')))
		{
		    $type = $payload['type'];
