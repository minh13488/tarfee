...
abstract class Core_Controller_Action_Standard extends Engine_Controller_Action
{
  ...
  public function postDispatch()
  {
	...
	&& !in_array($page_id, array('core_index_index', 'ynvideo_index_popup-view','tfcampaign_profile_index','ynblog_index_view','ynevent_profile_index','user_player-card_view','advgroup_profile_index','user_profile_index')) 
