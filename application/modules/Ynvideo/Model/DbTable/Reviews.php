...
class Ynvideo_Model_DbTable_Reviews extends Engine_Db_Table
{
	protected $_rowClass = 'Ynvideo_Model_Review';
	protected $_name = 'ynvideo_reviews';
	...
	public function getReviewed($resource_id, $user_id)
	{
		$select = $this -> select();
		$select
