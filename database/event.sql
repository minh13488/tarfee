...
-- 6/6
ALTER TABLE `engine4_event_events` ADD `country_id` INT(11) NULL AFTER `title`;
ALTER TABLE `engine4_event_events` ADD `province_id` INT(11) NULL AFTER `title`;
ALTER TABLE `engine4_event_events` ADD `city_id` INT(11) NULL AFTER `title`;